Tras esta revisión bibliográfica se detectan las siguientes brechas de investigación (\textit{research gaps}) que dan lugar a nuestra propuesta de investigación. %en conjunto del estudio bibliográfico, señalando las brechas de investigación (\textit{research gaps}) que se han detectado. De esta manera, se justifica la formulación de las preguntas de investigación que guiarán los capítulos siguientes, así como la propuesta para resolverlas.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \subsection{Research gaps y oportunidades\label{SUBSEC:RESGAPS}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% ¿Cómo se puede discernir cuándo unas técnicas superan a otras, y cuándo no?
